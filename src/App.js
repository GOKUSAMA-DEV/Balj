      ...
      <div className="section1">
        <div className="section1-right">
          <div className="main-cont">
            <p>Find Top Colleges, <br />Coaching, Courses..!</p>
          </div>
        ...
        <div className="section-left">
          <div className="image">
            <img src="https://www.collegedisha.com/_next/image?url=%2Fassets%2Fimages%2FcounsellingCard.webp&w=384&q=75" />
          </div>
        ...
        <div className="section3">
          ...
          <div className="section3-parts">
            <div className="section3-left">
              <div>
                <img src="https://www.collegedisha.com/assets/images/for-student.webp" />
              </div>
              <div className="left2">
